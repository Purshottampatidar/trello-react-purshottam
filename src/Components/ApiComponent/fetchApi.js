...
export const fetchAllListInfo=(boardId,setListData,setLoading,setError)=>{
  const allListUrl = `https://api.trello.com/1/boards/${boardId}/lists?key=${apiKey}&token=${token}`;
  axios.get(allListUrl)
    .then((response)=>{
